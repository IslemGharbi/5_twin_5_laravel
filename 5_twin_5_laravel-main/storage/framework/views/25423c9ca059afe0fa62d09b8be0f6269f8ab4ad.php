            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="advance-search">
                        <form action="<?php echo e(route('gig.search')); ?>" method="get">
                            <?php echo csrf_field(); ?>
                            <div class="form-row">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="search-result bg-gray">
                        ...
                        <?php else: ?>
                            <h2>Results For "<?php echo e($searchValue); ?>"</h2>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.freelancer_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\FELFEL\Downloads\5_twin_5_laravel-main (1)\5_twin_5_laravel-main\resources\views/gig/search.blade.php ENDPATH**/ ?>