                        ...
                        <div class="widget user-dashboard-menu">
                            <ul>
                                <?php if(Auth::user()->freelancer): ?>
                                    <li><a href="<?php echo e(route('order.list')); ?>"><i class="fa fa-user"></i>My
                                            Orders
                                            (Freelancer)<span><?php echo e(Auth::user()->freelancer->order->count()); ?></span></a>
                                    </li>
                                <?php endif; ?>
                                <li class="active"><a href="<?php echo e(route('orders')); ?>"><i
                                            class="fa fa-shopping-cart"></i> My Purchases
                        ...
                        <table class="table table-responsive product-dashboard-table">
                            ...
                            <tbody>
                                <?php
                                    $i = 0;
                                ?>
                                <?php $__currentLoopData = Auth::user()->order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                        $i++;
                                    ?>
                                    <tr>
                                        ...
                                        <td class="product-details">
                                            ...
                                            <span class="add-id"><strong>Freelancer:</strong>
                                                <a
                                                    href="<?php echo e(route('user.show', ['id' => $order->freelancer->user->id])); ?>">
                                                    <?php echo e($order->freelancer->user->name); ?>

                                                </a>
                                            </span>
                                            <span class="add-id"><strong>Type:</strong>
                                                $<?php echo e($order->option->name); ?></span>
                                                    ...
                                                    <ul class="list-inline justify-content-center">
                                                        <li class="list-inline-item">
                                                            <a data-toggle="tooltip" data-placement="top" title="view"
                                                                class="view"
                                                                href="<?php echo e(route('gig.show', ['id' => $order->gig_id])); ?>">
                                                                <i class="fa fa-eye"></i>
                                                            </a>
                                                        </li>
                                                    </ul>
...
<?php echo $__env->make('layouts.freelancer_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\FELFEL\Downloads\5_twin_5_laravel-main (1)\5_twin_5_laravel-main\resources\views/order/user.blade.php ENDPATH**/ ?>