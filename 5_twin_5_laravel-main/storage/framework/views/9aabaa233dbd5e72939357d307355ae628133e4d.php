            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6 my-lg-0 my-3">
                    <div class="counter-content text-center bg-light py-4 rounded">
                        ...
                        <span class="counter my-2 d-block" data-count="<?php echo e($user->count()); ?>">0</span>
                        <h5>Users</h5>
                        </script>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 my-lg-0 my-3">
                    <div class="counter-content text-center bg-light py-4 rounded">
                        ...
                        <span class="counter my-2 d-block" data-count="<?php echo e($freelancer->count()); ?>">0</span>
                        <h5>Freelancers</h5>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 my-lg-0 my-3">
                    <div class="counter-content text-center bg-light py-4 rounded">
                        ...
                        <span class="counter my-2 d-block" data-count="<?php echo e($gig->count()); ?>">0</span>
                        <h5>Gigs</h5>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 my-lg-0 my-3">
                    <div class="counter-content text-center bg-light py-4 rounded">
                        ...
                        <span class="counter my-2 d-block" data-count="<?php echo e($order->count()); ?>">0</span>
...
<?php echo $__env->make('layouts.freelancer_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\FELFEL\Downloads\5_twin_5_laravel-main (1)\5_twin_5_laravel-main\resources\views/about.blade.php ENDPATH**/ ?>