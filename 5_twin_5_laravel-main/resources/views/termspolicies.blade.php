...
<section class="section  bg-gray py-5">
    <div class="container">
        <div>
            <p>Welcome to Opportunity!</p>

            <p>These terms and conditions outline the rules and regulations for the use of Opportunity's Website.</p>
            ...
            <p>We employ the use of cookies. By accessing Opportunity, you agreed to use cookies in agreement with the
                Opportunity's Privacy Policy. </p>
            ...
            <p>Unless otherwise stated, Opportunity and/or its licensors own the intellectual property rights for all
                material on Opportunity. All intellectual property rights are reserved. You may access this from
                Opportunity
                for your own personal use subjected to restrictions set in these terms and conditions.</p>

            <p>You must not:</p>
            <ul class="list-unstyled">
                <li>Republish material from Opportunity</li>
                <li>Sell, rent or sub-license material from Opportunity</li>
                <li>Reproduce, duplicate or copy material from Opportunity</li>
                <li>Redistribute content from Opportunity</li>
            </ul>


            <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                certain
                areas of the website. Opportunity does not filter, edit, publish or review Comments prior to their
                presence
                on the website. Comments do not reflect the views and opinions of Opportunity,its agents and/or
                affiliates.
                Comments reflect the views and opinions of the person who post their views and opinions. To the extent
                permitted by applicable laws, Opportunity shall not be liable for the Comments or for any liability,
                damages
            ...
            <p>Opportunity reserves the right to monitor all Comments and to remove any Comments which can be considered
            ...
            <p>You hereby grant Opportunity a non-exclusive license to use, reproduce, edit and authorize others to use,
            ...
            <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
                ...
                Opportunity; and (d) the link is in the context of general resource information.</p>
            ...
            <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                website,
                you must inform us by sending an e-mail to Opportunity. Please include your name, your organization
                name,
            ...
            <p>No use of Opportunity's logo or other artwork will be allowed for linking absent a trademark license
                agreement.</p>
