                        ...
                        <div class="widget user-dashboard-menu">
                            <ul>
                                @if (Auth::user()->freelancer)
                                    <li><a href="{{ route('order.list') }}"><i class="fa fa-user"></i>My
                                            Orders
                                            (Freelancer)<span>{{ Auth::user()->freelancer->order->count() }}</span></a>
                                    </li>
                                @endif
                                <li class="active"><a href="{{ route('orders') }}"><i
                                    ...
                                    <tr>
                                        ...
                                        <td class="product-details">
                                            ...
                                            <span class="add-id"><strong>Freelancer:</strong>
                                                <a
                                                    href="{{ route('user.show', ['id' => $order->freelancer->user->id]) }}">
                                                    {{ $order->freelancer->user->name }}
                                                </a>
                                            </span>
                                                    ...
                                                    <ul class="list-inline justify-content-center">
                                                        <li class="list-inline-item">
                                                            <a data-toggle="tooltip" data-placement="top" title="view"
                                                                class="view"
                                                                href="{{ route('gig.show', ['id' => $order->gig_id]) }}">
                                                                <i class="fa fa-eye"></i>
                                                            </a>
                                                        </li>
                                                    </ul>
